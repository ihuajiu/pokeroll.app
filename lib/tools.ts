...
export const TOOLS: ToolMeta[] = [
  ...
  },
  {
    ...
    desc: "Roll a random challenge idea — Nuzlocke, Monotype and more.",
    group: "challenge",
    icon: "🎲",
  },
  {
...
export const RELATED_TOOLS: Record<string, string[]> = {
  ...
  "/challenge": ["/challenge/guess", "/challenge/shiny", "/adventure", "/wheel", "/random-pokemon-generator"],
  "/challenge/guess": ["/no-names", "/challenge/shiny", "/challenge", "/wheel", "/adventure"],
  "/challenge/shiny": ["/challenge/guess", "/challenge", "/legendary", "/adventure", "/random-pokemon-generator"],
