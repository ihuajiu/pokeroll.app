...
export const metadata: Metadata = {
  ...
  description:
    "Randomize a Pokémon in one tap — every roll comes with its name, type, ability, base stats, generation and official artwork, ready to copy to Showdown. Free fan-made tool.",
  keywords: [
    "pokemon randomizer",
