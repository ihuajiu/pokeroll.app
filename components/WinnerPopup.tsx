...
export default function WinnerPopup({
  ...
  return (
    ...
    >
      <div
        className={"relative w-full max-w-4xl overflow-hidden rounded-2xl shadow-2xl " + modalCls}
      ...
      >
        ...
        <div className="max-h-[94vh] overflow-y-auto overflow-x-hidden p-4">

          {previewSrc ? (
            <img src={previewSrc} alt={data.name} className="mx-auto h-auto max-h-[62vh] w-auto max-w-full rounded-xl" />
          ) : (
